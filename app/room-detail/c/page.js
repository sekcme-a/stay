...
const ROOM_IMAGE_LIST = [
  {img:"/assets/images/custom/rooms/c/008.png", alt:"방 c 사진 1"},
  {img:"/assets/images/custom/rooms/c/009.png", alt:"방 c 사진 1"},
  {img:"/assets/images/custom/rooms/c/010.png", alt:"방 c 사진 1"},
  {img:"/assets/images/custom/rooms/c/011.png", alt:"방 c 사진 1"},
]
...
export default function Home() {
    ...
    return (
        <>
            <Layout headerStyle={2} footerStyle={1} breadcrumbTitle="PART1 C">
                <div>
                    ...
                    <div className="row">
                      <div className="col-lg-8 pe-lg-35">
                        <div className="single-post">
                          <span className="section_heading_title_small">150,000~170,000₩₩</span>
                          <h2 className="mb_40">PART1 C</h2>
                          <p className="mb_20" style={{whiteSpace:"pre-line"}}>
                            {`4인/최대 8인 권장
                            1층에 위치해 있어 보다 편리하며, 바베큐 이용에 좀 더 용의합니다. 방이 2개 제공되며, 방앞에 8명 이상 수용가능한 전용 실외 바베큐장이 있습니다.`}
                          </p>
                    ...
                    <div className="d-flex align-items-center">
                      ...
                      <p className="fw_medium mb_0">Drink</p>
                          ...
                          <ul className="list-2 mb_70">
                            ...
                            <li>
                              <i className="icon-23"></i>체크아웃: 1:00 PM
                            </li>
                            <li>
