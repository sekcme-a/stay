...
export default function Layout({ headerStyle, footerStyle, headTitle, bgType, breadcrumbTitle, children, wrapperCls }) {
    ...
    return (
        <>
            ...
            <div className={`page-wrapper ${wrapperCls ? wrapperCls : ""}`} id="#top">
                ...
                {breadcrumbTitle && <Breadcrumb breadcrumbTitle={breadcrumbTitle} bgType={bgType} />}
